import s from "../assets/sass/pageLoading.module.scss";

const Span = () => <span className={s.drop}></span>;
...
export default function PageLoading() {
  ...
  return (
    <div className={s.preloader} style={{ opacity: 1 }}>
      <svg version="1.1" className={s.sun} xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" background="new 0 0 10 10" space="preserve" style={{ opacity: 1, marginLeft: 0, marginTop: 0 }}>
        <g>
      ...
      <svg version="1.1" className={s.cloud} xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" background="new 0 0 10 10" space="preserve">
      ...
      <div className={s.rain}>{drawSpans()}</div>
